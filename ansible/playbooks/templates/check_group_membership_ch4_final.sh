...
#            _____          _____________        _____ _____ _____
#            _____          ____      _____      _____  ___  _____
#        _____________    ________________     _______   _   _______
#        _____________    ______________       _______       _______
#
################################################################################
#    Filename: check_group_membership.sh
# Description: This module checks if a specified user is member of a specified group.
#   Reference: N/A
#       Input: user, group, fail
#      Output: JSON object with command status
#       Usage: From module (method 1):
#               check_group_membership: user=abc group=def behavior=inform/fail
#
#              From module (method 2):
#               check_group_membership:
#                 user: abc
#                 groups: def
#                 behavior: inform/fail
#
#              From sh:
#               user=abc group=def behavior=inform/fail ./add_user_to_group.sh
#     Pre-req: user and group variables are required.
